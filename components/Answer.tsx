...
const Answer = (
    {
        answer: _answer, //okay why the _answer we are taking the the value of key answer and naming it as _answer and assigning that to answer to avoid confflist
        questionId,
    }:
        {
            answer: Models.DocumentList<Models.Document>,
            questionId: string
        }
) => {
    const [answers, setAnswers] = React.useState(_answer);
